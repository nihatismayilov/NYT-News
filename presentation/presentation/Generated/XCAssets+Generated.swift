...
internal enum Asset {
  internal enum Colors {
    ...
    internal static let redWithDark = ColorAsset(name: "redWithDark")
    ...
    internal static let tabbarInverse = ColorAsset(name: "tabbarInverse")
  ...
  internal enum Media {
    ...
    internal static let icIcon = ImageAsset(name: "icIcon")
    internal static let newsLogo = ImageAsset(name: "newsLogo")
    internal static let tabbar1 = ImageAsset(name: "tabbar1")
    internal static let tabbar1Selected = ImageAsset(name: "tabbar1Selected")
    ...
    internal static let icName = ImageAsset(name: "icName")
    internal static let icPassword = ImageAsset(name: "icPassword")
    ...
    internal static let profileLogoutIcon = ImageAsset(name: "profileLogoutIcon")
    internal static let profilePhoneIcon = ImageAsset(name: "profilePhoneIcon")
    internal static let profilePrivacyIcon = ImageAsset(name: "profilePrivacyIcon")
